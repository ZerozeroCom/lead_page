window.LANG = {
  ...
  "notice": {
    ...
    "item2": "2. 請填寫實際轉帳所使用的銀行帳戶資料",
    "item3": "3. 資訊填寫錯誤可能導致款項無法及時入帳！",
    "item4": "4. 請在限定時間內完成操作，超時將無法繼續！",
    "item5": "5. 付款完成後請勿重複操作"
  },
  "order": {
    "sectionTitle": "訂單詳細資訊",
    ...
    "copy": "複製",
    "copyOrderIdAria": "複製訂單號",
    "copyOrderAmountAria": "複製訂單金額",
    "copyPrompt": "複製以下內容："
  },
  "form": {
  ...
  "footer": {
    "item0": "溫馨提醒",
    "item1": "請確認付款資訊正確無誤後再進行操作。",
    "item2": "付款後請勿儲存該帳戶信息。",
    "item3": "若長時間未到帳，請聯系在線客服。",
    "item4": "訂單超時請重新建單，請勿超時支付，避免資金受損，我司概不負責。"
  },
  "paymentFields": {
