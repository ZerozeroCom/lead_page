window.LANG = {
  ...
  "overlay": {
    ...
    "paymentExpiredTitle": "付款时间已超时",
    "expiredMessage": "本次付款已超过有效时间，请重新发起付款请求。",
  ...
  "notice": {
    ...
    "item2": "2. 请填写实际转账所使用的银行账户资料",
    "item3": "3. 信息填写错误可能导致款项无法及时入账！",
    "item4": "4. 请在限定时间内完成操作，超时将无法继续！",
    "item5": "5. 付款完成后请勿重复操作"
  },
  "order": {
    "sectionTitle": "订单详细信息",
    ...
    "copy": "复制",
    "copyOrderIdAria": "复制订单号",
    "copyOrderAmountAria": "复制订单金额",
    "copyPrompt": "复制以下内容："
  },
  "form": {
